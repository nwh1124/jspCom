...
public class ArticleController {
	...
	public String doWrite(HttpServletRequest req, HttpServletResponse resp) {
		...
		if( req.getParameter("memberId") != null || req.getParameter("boardId") != null 
				|| req.getParameter("title") != null || req.getParameter("body") != null ) {
		...
		RequestDispatcher rd = req.getRequestDispatcher("/jspCommunity/usr/article/formWrite.jsp");
		try {
			rd.forward(req, resp);
	...
	public String doModify(HttpServletRequest req, HttpServletResponse resp) {
		...
		if( req.getParameter("articleId") != null || req.getParameter("memberId") != null 
				|| req.getParameter("title") != null || req.getParameter("body") != null ) {
		...
		RequestDispatcher rd = req.getRequestDispatcher("/jspCommunity/usr/article/formModify.jsp");
		try {
			rd.forward(req, resp);
		} catch (ServletException e) {
			e.printStackTrace();
